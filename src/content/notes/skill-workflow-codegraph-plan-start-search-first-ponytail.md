...
![요구사항, 범위, 시스템 흐름, 검증 기준을 하나의 계획 문서에 정리한 모습](../../assets/images/skill-plan-start.png)

*코드를 쓰기 전 목표·범위·영향·검증 기준을 먼저 맞춥니다.*
...
![기존 저장소의 파일과 코드에서 재사용할 구현을 돋보기로 찾는 모습](../../assets/images/skill-search-first.png)

*새 코드를 만들기 전에 기존 책임자와 비슷한 패턴부터 찾습니다.*
...
![중심 코드 모듈과 호출 관계, 변경 영향 범위를 보여 주는 코드 그래프](../../assets/images/skill-codegraph.png)

*중심 변경이 어디까지 이어지는지 호출 관계와 영향 범위로 확인합니다.*
...
![불필요한 컴포넌트와 의존성을 덜어내고 검증된 최소 구현을 남긴 코드 화면](../../assets/images/skill-ponytail.png)

*불필요한 레이어는 덜어내되, 검증과 안전장치는 남깁니다.*
